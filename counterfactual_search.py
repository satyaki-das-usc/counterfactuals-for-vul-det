...
class GreedySearch(BaseCounterfactualSearch):
    ...
    def search(self, document):
        logging.basicConfig(level=logging.DEBUG, filename='search.log', filemode='w')
        ...
        for i in range(self.iterations+1):
            ...
            for i in range(len(candidate_classifications)):
                ...
                logging.debug(f"Document after perturbing positions {candidate_positions}:\n{counterfactual_document}")
